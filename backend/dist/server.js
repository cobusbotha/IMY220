...
var url = "mongodb+srv://".concat(process.env.MONGODBUSERNAME, ":").concat(encodeURIComponent(process.env.MONGODBPASSWORD), "@imy220.p46ps.mongodb.net/?retryWrites=true&w=majority&appName=IMY220");
        ...
        case 3:
          ...
          app.post('/api/register', /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
              var _req$body, username, password, email, count, newId, hashedPassword, newUser;
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  ...
                  case 20:
                    ...
                    console.error("Error logging in user:", _context7.t0);
          ...
          app.listen(PORT, function () {
            console.log("Running on port http://localhost:".concat(PORT, "\n"));
          });
        case 30:
        case "end":
